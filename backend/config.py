...
class Settings(BaseSettings):
    ...
    # Email
    smtp_email: str = Field(default="", env="SMTP_EMAIL")
    smtp_app_password: str = Field(default="", env="SMTP_APP_PASSWORD")
    ...
    # Platform charges
    platform_charge_online: int = Field(default=10, env="PLATFORM_CHARGE_ONLINE")
    platform_charge_cod: int = Field(default=15, env="PLATFORM_CHARGE_COD")
